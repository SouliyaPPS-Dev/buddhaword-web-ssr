                ...
                <div class="flex justify-between items-center mt-3">
                    ...
                    <div class="flex items-center gap-1 sm:gap-2">
                        ...
                        <div x-data="{ 
                            ...
                            <button @click="toggleFavorite()" class="p-2 sm:p-3 rounded-full bg-white/10 hover:bg-white/20 transition-colors" :class="isFavorite ? 'text-red-400' : 'text-white/50'">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 sm:h-8 sm:w-8" :fill="isFavorite ? 'currentColor' : 'none'" viewBox="0 0 24 24" stroke="currentColor">
