...
var CACHE = "buddhaword-v7";
var STATIC_CACHE = "buddhaword-static-v7";
var ASSETS_CACHE = "buddhaword-assets-v7";
...
self.addEventListener("fetch", function (event) {
  ...
  if (
    ...
    // For static assets: cache-first with network update in background
    event.respondWith(
